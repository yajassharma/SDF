        ...
        <div className="absolute inset-0 z-10 pointer-events-none">
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row gap-4 md:gap-6 mt-8 md:mt-12 items-center">
                    ...
                    <button className="glass text-white font-bold py-3.5 px-6 md:py-4 md:px-8 rounded-full hover:bg-white/10 transition-all duration-300 text-sm md:text-base">
                        Become a Creator
                    </button>
                </div>
            </motion.div>
